<style scoped>
    #ai-page{}
    #ai-page .section {padding: .5rem;background:#fff;}
        ...
        <div class="section clearfix">
            ...
            <div class="line fleft">
                <div class="boxF fleft">
                    <div class="boxS">
                        <img class="boxT" data="img1" src="../images/works/AI/001.jpg" alt="" @click="showBigImg($event)">
                        <!--<div class="boxT" style="background-image: url(./src/images/works/AI/001.jpg);"></div>-->
                    </div>
                </div>
                <div class="boxF fleft">
                    <div class="boxS">
                        <img class="boxT" data="img2" src="../images/works/AI/002.jpg" alt="" @click="showBigImg($event)">
                        <!--<div class="boxT" style="background-image: url(./src/images/works/AI/002.jpg);"></div>-->
                    </div>
                </div>
                <div class="boxF fleft">
                    <div class="boxS">
                        <img class="boxT" data="img3" src="../images/works/AI/003.jpg" alt="" @click="showBigImg($event)">
                        <!--<div class="boxT" style="background-image: url(./src/images/works/AI/003.jpg);"></div>-->
                    </div>
                </div>
            </div>
            <!--第二行(lineSecond)-->
            <div class="line fleft">
                <div class="boxF fleft">
                    <div class="boxS">
                        <img class="boxT" data="img4" src="../images/works/AI/004.jpg" alt="" @click="showBigImg($event)">
                        <!--<div class="boxT" style="background-image: url(./src/images/works/AI/004.jpg);"></div>-->
                    </div>
                </div>
                <div class="boxF fleft">
                    <div class="boxS">
                        <img class="boxT" data="img5" src="../images/works/AI/005.jpg" alt="" @click="showBigImg($event)">
                        <!--<div class="boxT" style="background-image: url(./src/images/works/AI/005.jpg);"></div>-->
                    </div>
                </div>
                <div class="boxF fleft">
                    <div class="boxS">
                        <img class="boxT" data="img6" src="../images/works/AI/006.jpg" alt="" @click="showBigImg($event)">
                        <!--<div class="boxT" style="background-image: url(./src/images/works/AI/006.jpg);"></div>-->
                    </div>
                </div>
            </div>
            <!--第三行(lineThird)-->
            <div class="line fleft">
                <div class="boxF fleft">
                    <div class="boxS">
                        <img class="boxT" data="img7" src="../images/works/AI/007.jpg" alt="" @click="showBigImg($event)">
                        <!--<div class="boxT" style="background-image: url(./src/images/works/AI/007.jpg);"></div>-->
                    </div>
                </div>
                <div class="boxF fleft">
                    <div class="boxS">
                        <img class="boxT" data="img8" src="../images/works/AI/008.jpg" alt="" @click="showBigImg($event)">
                        <!--<div class="boxT" style="background-image: url(./src/images/works/AI/008.jpg);"></div>-->
                    </div>
                </div>
                <div class="boxF fleft">
                    <div class="boxS">
                        <img class="boxT" data="img9" src="../images/works/AI/009.jpg" alt="" @click="showBigImg($event)">
                        <!--<div class="boxT" style="background-image: url(./src/images/works/AI/009.jpg);"></div>-->
                    </div>
                </div>
            </div>
        </div>
